...
requirements = ['gevent==1.2.2', 'Flask_Migrate==2.0.2', 'Flask_SocketIO==2.9.3',
                ...
                'PyJWT==1.6.0', 'paho_mqtt==1.3.1', 'socketIO_client==0.7.2', 'psycopg2==2.7.4', 'pytest',
                'flask-login', 'flask_session']
dev_requirements = ['httpretty==0.8.14', 'coverage']

links = ['https://github.com/eclipse/paho.mqtt.python']
